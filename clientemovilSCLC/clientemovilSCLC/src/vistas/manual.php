        ...
        /*if (!empty($_POST["btningresar"])) {
            if (empty($_POST["cveusuario"]) and empty($_POST["pass1"])) {
                ...
                Swal.fire({
                    ...
                    header("location: /clientemovil2023/index.php");
                }
            }
        }*/
        ?>
                                            ...
                                            <div>
                                                <form method="post">
                                                    ...
                                                    <div class="form-floating mb-3">
                                                        <input name=cveElectoral class="form-control mr-sm-2 my-2" type="text" onkeyup="this.value = this.value.toUpperCase();" placeholder="Clave Electoral" required maxlength="18"/>
